...
#from .gpm_bar_smoother import _reconstruct_original_variables
...
def extract_reconstructed_components_fixed( # Corrected name from extract_reconstructed_components
    ...
    for i_loop, mcmc_draw_idx in enumerate(draw_indices):
        ...
        reconstructed_trends_this_draw, reconstructed_stationary_this_draw = _reconstruct_original_variables(
            core_states_smoothed_draw,
            gpm_model,
            ss_builder, 
            current_builder_params_draw,
            T_data,
            state_dim
        )
        # # Reconstruct original GPM trend variables (can be core or non-core)
