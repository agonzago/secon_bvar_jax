...
custom_plot_specifications = [
    ...
    },
    {
        ...
        "series_to_plot": [
            {'type': 'trend', 'name': 'trend_y_us', 'label': 'US Trend Component', 'show_hdi': True, 'color': 'purple'},
            {'type': 'observed', 'name': 'y_us', 'label': 'Observed US', 'style': 'k--'}
        ]
    },
    {
        ...
        "series_to_plot": [
            {'type': 'trend', 'name': 'trend_y_ea', 'label': 'EA Trend Component', 'show_hdi': True, 'color': 'orange'},
            {'type': 'observed', 'name': 'y_ea', 'label': 'Observed EA', 'style': 'k--'}
        ]
    },
    {
        ...
        "series_to_plot": [
            {'type': 'trend', 'name': 'trend_y_jp', 'label': 'JP Trend Component', 'show_hdi': True, 'color': 'gray'},
            {'type': 'observed', 'name': 'y_jp', 'label': 'Observed JP', 'style': 'k--'}
        ]
    }
]
...
results = complete_gpm_workflow_with_smoother_fixed(
    ...
    generate_plots = True,
    hdi_prob_plot  = 0.9,
    show_plot_info_boxes = False,      # Optional: hide default info boxes
